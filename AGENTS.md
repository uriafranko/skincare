...
Skintext is a Bun/Turborepo monorepo for an iMessage skincare routine assistant. Keep this file short: only durable facts and commands that future agents should use almost every time.
